...
//--------------------------------------------------------------------------------
	html_menu_head(&protocol_status, "System Reset");//TITLE_RESET);	//neil: simplify
//--------------------------------------------------------------------------------

	printf("%s", "<table width=\"740\" height=\"200\" border=\"1\">\n");
	printf("%s", "  <tr>\n");
	printf("%s", "    \n");
	printf("%s", "    <td colspan=\"2\">\n");
	printf("%s", "      \n");
	printf("%s", "      <p><p align=\"center\">\n");
	printf("%s", "    <font face=\"Arial, Helvetica, sans-serif\" size=\"3\"><b><font color=\"#000000\" size=\"4\">Are you sure you want to reset this repeater ?</font></a></b></font>\n");
	printf("%s", "	<p><p align=\"center\"><font face=\"Arial, Helvetica, sans-serif\" size=\"3\"><b><a href=\"html.cgi?function=reset_module\"><font color=\"#000000\" size=\"4\">Yes</font></a></b></font>\n");
	printf("%s", "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	  \n");
	printf("%s", "	  <font face=\"Arial, Helvetica, sans-serif\" size=\"3\"><b><a href=\"html.cgi?function=list\"><font color=\"#000000\" size=\"4\">No</font></a></b></font>\n");
	printf("%s", "\n");
	printf("%s", "  </tr>\n");
	printf("%s", "</table>\n");
