...
//--------------------------------------------------------------------------------
	html_menu_head(&protocol_status, "List");
//--------------------------------------------------------------------------------
	printf("%s", "<br>");

	printf("%s", "<table width=\"746\" height=\"150\" border=\"1\">\n");
	printf("%s", "  <tr><td>\n");
	printf("%s", "    <p align=\"center\">\n");
	printf("%s", "    <font face=\"Arial, Helvetica, sans-serif\" color=\"#000000\" size=\"4\"><b><font >Select function</font></b>\n");
	printf("%s", "    <p><p align=\"center\">\n");
	printf("%s", "    <button type=\"button\" name=\"SetupWizard\" style=\"WIDTH: 160pt; HEIGHT: 30pt\" onClick=\"location.href='html.cgi?function=tree_rfconfig';this.disabled=true\"><b><font color=\"#000000\" size=\"2\">RF configuration</font></b></button>\n");//Setup wizard
	printf("%s", "    &nbsp;&nbsp\n");
	printf("%s", "    <button type=\"button\" name=\"Status\" style=\"WIDTH: 160pt; HEIGHT: 30pt\" onClick=\"location.href='html.cgi?function=tree_status';this.disabled=true\"><b><font color=\"#000000\" size=\"2\">Status monitor</font></b></button>\n");
	printf("%s", "  </td></tr>\n");
