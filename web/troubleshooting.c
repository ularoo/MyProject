...
//--------------------------------------------------------------------------------
	html_menu_head(&protocol_status, "Troubleshooting");//TITLE_TROUBLE);	//neil: simplify
//--------------------------------------------------------------------------------
	printf("%s", "  </form>");
...
*/
	...
	printf("%s", "      <p><p align=\"left\">\n");
	printf("%s", "<font color=\"#000000\" size=\"3\" face=\"Arial, Helvetica, sans-serif\"><b>");
	printf("%s", "&nbsp;&nbsp;Toll Free: 1-866-9-GST-USA {Technical Support}</br>\n");
	printf("%s", "&nbsp;&nbsp;support@gsteletechinc.com</br>\n");
	printf("%s", "</br>\n");
	printf("%s", "&nbsp;&nbsp;Contact Information</br>\n");
	printf("%s", "&nbsp;&nbsp;GS Teletech Inc.</br>\n");
	printf("%s", "&nbsp;&nbsp;6900 College Blvd., Suite 850</br>\n");
	printf("%s", "&nbsp;&nbsp;Overland Park, KS 66211</br>\n");
	printf("%s", "</br>\n");
	printf("%s", "&nbsp;&nbsp;Tel: 913-469-6699</br>\n");
	printf("%s", "&nbsp;&nbsp;Fax: 913-661-0163</br>\n");
	printf("%s", "&nbsp;&nbsp;www.gsteletechinc.com</br>\n");
	printf("%s", "  </tr>\n");
	printf("%s", "</table>\n");
	printf("%s", "</body>\n");
	printf("%s", "</html>\n");
