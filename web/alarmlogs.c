...
//--------------------------------------------------------------------------------
	html_menu_head(&protocol_status, "Alarm Log");

//--------------------------------------------------------------------------------
	printf("<form name=\"form1\" method=\"POST\" action=\"html.cgi\">\n");
	printf("<input name=\"alarm_clear\" type=\"checkbox\" checked value=\"0\" style=\"display:none\">\n");
	...
	printf("		<p align=\"left\"><font size=\"5\"><b>&nbsp;Alarm Log</b></font></p></td>\n");
	...
	printf("    <td width=\"80\" ><p align=\"center\"><b>Number</b></p></td>\n");
	printf("    <td width=\"150\" ><p align=\"center\"><b>Last Triggered</b></p></td>\n");
	printf("    <td width=\"100\" ><p align=\"center\"><b>Status</b></p></td>\n");
	printf("    <td width=\"170\" ><p align=\"center\"><b>Module</b></p></td>\n");
	printf("    <td width=\"240\" ><p align=\"center\"><b>Alarm Name</b></p></td>\n");
	printf("  </tr>\n");

	get_alarm_log(alarm_page);
