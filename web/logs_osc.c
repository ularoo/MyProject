...
//--------------------------------------------------------------------------------
	html_menu_head(&protocol_status, "Oscillation Log");

//--------------------------------------------------------------------------------
	printf("<form name=\"form1\" method=\"POST\" action=\"html.cgi\">\n");
	printf("<input name=\"osc_log_clear\" type=\"checkbox\" checked value=\"0\" style=\"display:none\">\n");
	...
	printf("		<p align=\"left\"><font size=\"5\"><b>&nbsp;Oscillation Log</b></font></p></td>\n");
	...
	printf("    <td ><p align=\"center\"><b>Number</b></p></td>\n");		//width=\"80\" 
	printf("    <td ><p align=\"center\"><b>Module</b></p></td>\n");		//width=\"170\" 
	printf("    <td ><p align=\"center\"><b>Attenuation</b></p></td>\n");	//width=\"240\" 
	printf("    <td ><p align=\"center\"><b>Triggered Time</b></p></td>\n");	//width=\"150\" 
	printf("  </tr>\n");

	get_osc_log(alarm_page);
